...
class zTextInputCase( zFormTestCase ):


    def setUp(self):
        super(zTextInputCase, self).setUp()
    ...
    def tearDown(self):
        super(zTextInputCase, self).tearDown()
        self.form = None
    ...
    def test_pattern_dates( self ):
        logger.debug( "\n" )
        class TestForm( forms.Form ):
            date = zTextInput( **{ 'pattern' : '\d{1,2}/\d{1,2}/\d{4}'  } )
