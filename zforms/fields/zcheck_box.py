...
class zCheckBox( HTMLAttributeOverrides, BooleanField ):

    def __init__(self, *args, **kwargs):

        '''
            default validators on BooleanField:
            ================================
            None
        ...
        super( zCheckBox, self ).__init__( *args, **kwargs )

    def to_python( self, value ):
        parent_value = super( zCheckBox, self).to_python( value )
        return parent_value

    def validate(self, value):
        super( zCheckBox, self ).validate( value )

    def clean( self, value ):
        value = self.to_python(value)
        self.validate(value)
        self.run_validators(value)
        logger.debug( "[ CheckBox Type ]: %s" % type( value ) )
