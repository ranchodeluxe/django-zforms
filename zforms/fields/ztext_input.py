...
class zTextInput( HTMLAttributeOverrides, CharField ):
    ...
    def __init__(self, *args, **kwargs):
        ...
        super( zTextInput, self ).__init__( *args, **kwargs )
        self._add_pattern_validator()

    def to_python( self, value ):
        parent_value = super( zTextInput, self).to_python( value )
        return parent_value

    def validate(self, value):
        super( zTextInput, self ).validate( value )
